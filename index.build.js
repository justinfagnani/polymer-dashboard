...
}, 0) : (c.he.window_features = 'menubar=yes,modal=yes,alwaysRaised=yeslocation=yes,resizable=yes,scrollbars=yes,status=yes,height=625,width=625,top=' + ('object' === typeof screen ? 0.5 * (screen.height - 625) : 0) + ',left=' + ('object' === typeof screen ? 0.5 * (screen.width - 625) : 0), c.he.relay_url = Ng(a.G.lc), c.he.requestWithCredential = u(a.uc, a), hh(a, e, '/auth/' + b, c, d));
}
function $g(a) {
...
h.Ng = function (a) {
a && !this.Sb && this.eb === this.Id && (this.f('Window became visible.  Reducing delay.'), this.eb = 1000, this.Ma || Th(this, 0));
this.Sb = a;
};
h.Lg = function (a) {
a ? (this.f('Browser went online.'), this.eb = 1000, this.Ma || Th(this, 0)) : (this.f('Browser went offline.  Killing connection.'), this.Ma && this.Ma.close());
};
h.If = function () {
...
var l = d ? d.T(k) : null, k = e.o(k), g = g.concat(Hi(a, m, c, l, k));
...
var m = o[row.gsx$maintainer.$t] || (o[row.gsx$maintainer.$t] = []);
m.push({
name: row.gsx$tool.$t,
...
requestQueue.push({
organization: mr.repos[i].organization,
...
if (repo) {
var name = repo.organization + '/' + repo.name;
...
this._filterAndAdd(response, /^Priority: Low/i, false, false, repo.path, 'p3');
